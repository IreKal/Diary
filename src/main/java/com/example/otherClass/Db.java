...
import com.example.contractsClass.IDatabase;
import com.example.modelClass.User;
import com.example.repositoryClass.DiaryRepository;
import com.example.repositoryClass.MySQL;
import com.example.repositoryClass.UserRepository;
import java.io.File;
...
public class Db {
    ...
    public static DiaryRepository diaryRepository() {
        return new DiaryRepository(Db.getMySQLDatabase());
    }
